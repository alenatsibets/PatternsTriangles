...
public class InputValidator {
    private static final Logger logger = LogManager.getLogger(InputValidator.class.getName());
    public static boolean hasTreeParameters(String[] param){
        boolean valid = true;
        if (param.length != 3) {
    ...
    public static Optional<Double[]> validParameters(String[] params){
        double sideA;
        double sideB;
        double sideC;
        try {
